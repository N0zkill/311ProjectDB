...
public class DbConnectivityClass {
    ...
    public static String status = "";
        ...
        final static String SQL_SERVER_URL = "jdbc:mysql://karacsc311server.mysql.database.azure.com";//update this server name
        final static String DB_URL = "/"+DB_NAME;//update this database name
        final static String USERNAME = "ebuadmin";// update this username
        final static String PASSWORD = "Gamer8540";// update this password
